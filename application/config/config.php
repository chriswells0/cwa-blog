...
define('SITE_NAME', 'My CWA Blog'); // Displayed at the top of every page.
define('SITE_SLOGAN', 'Welcome to my CWA Blog!'); // Shown below SITE_NAME.
define('SITE_TITLE', 'My CWA Blog'); // Displayed in title bar.
